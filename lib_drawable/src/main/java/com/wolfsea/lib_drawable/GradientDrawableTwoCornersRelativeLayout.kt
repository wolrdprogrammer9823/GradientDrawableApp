...
/**
 *@desc GradientDrawableTwoCornersRelativeLayout
 *@author:liuliheng
 *@time: 2021/4/1 23:36
**/
class GradientDrawableTwoCornersRelativeLayout : RelativeLayout {
    ...
    **/
    private fun init(context: Context?, attributeSet: AttributeSet?) {
        ...
        GradientTwoCornersDrawableUtil.Builder(fillColor, this@GradientDrawableTwoCornersRelativeLayout)
