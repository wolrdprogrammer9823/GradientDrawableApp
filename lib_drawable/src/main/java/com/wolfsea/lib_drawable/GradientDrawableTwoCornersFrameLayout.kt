...
/**
 *@desc  GradientDrawableTwoCornersFrameLayout
 *@author:liuliheng
 *@time: 2021/4/1 23:38
**/
class GradientDrawableTwoCornersFrameLayout : FrameLayout {
    ...
    **/
    private fun init(context: Context, attributeSet: AttributeSet?) {
        ...
        GradientTwoCornersDrawableUtil.Builder(fillColor, this@GradientDrawableTwoCornersFrameLayout)
